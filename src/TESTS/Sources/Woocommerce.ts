import { WooCommerceOrder } from "../../Sources/adapters/Woocommerce";
import Sources, { EnumSources } from "../../Sources/Sources";

async function testWoocommerceSource() {
  const sampleWoocommerceOrder: WooCommerceOrder = {
    id: 193,
    parent_id: 0,
    status: "processing",
    currency: "XAF",
    ...
    refunds: [],
    payment_url:
      "https://afriall.com/commander/order-pay/193/?pay_for_order=true&key=wc_order_19qQFmIDydDjk",
    is_editable: false,
    needs_payment: false,
  ...
  const woocommerceSource = Sources.getSource(EnumSources.WOOCOMMERCE);
  try {
