...
const timezone_1 = __importDefault(require("../Config/timezone"));
class Time {
    /**
     ...
     */
    static convertUTCToTimezone(date, targetTimezone = timezone_1.default) {
        const dateObj = typeof date === "string" ? new Date(date) : date;
        // Create a date in target timezone
        const targetDate = new Date(dateObj.toLocaleString("en-US", { timeZone: targetTimezone }));
     ...
     */
    static convertToUTC(dateString, sourceTimezone = timezone_1.default) {
        ...
        const utcDate = new Date(Date.UTC(dateParts.year, dateParts.month - 1, // Month is 0-based
